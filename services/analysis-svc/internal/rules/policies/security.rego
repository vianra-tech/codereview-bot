...
sql_injection[result] {
    ...
    result := {
        ...
        "code_snippet": input.source[call.start_byte:call.end_byte]
    }
}
...
hardcoded_secret[result] {
    assignment := ast.assignment
    assignment.target.matches("(?i)(password|secret|token|key|api_key|apikey)")
